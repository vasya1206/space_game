...
def dialogue_mode(sprite, text):
    ...
    text1 = f1.render(text[text_number], True, pg.Color("blue"))
    screen.blit(text1, (280, 450))
    if text_number < len(text) - 1:
        text2 = f1.render(text[text_number + 1], True, pg.Color("blue"))
...
size = (800, 600)
screen: Surface | SurfaceType = pg.display.set_mode(size)
...
pg.mixer.music.load('cat.space_sound.wav')
